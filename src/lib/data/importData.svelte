<script>
	...
	import { data, menuModalType } from '../store.svelte.js';
	import { guessDateofArray, forceFormat, getPeriod } from '../utils/time/TimeUtils';
  ...
  */
	...
	function makeTempTable(tempData) {
		...
		Object.keys(tempData).forEach((heading) => (table += `<th>${heading}</th>`));
