...
describe('fitCosinorFixed', () => {
	...
	it('fits a two-harmonic model with R² > 0.99 on a two-harmonic signal', () => {
		...
		for (let ti = 0; ti <= 96; ti += 0.25) {
			...
			y.push(10 + 2 * Math.cos(omega * ti + 0.3) + 1 * Math.cos(2 * omega * ti + 1.1));
		}
...
describe('fitCosinorFixed F-test vs scipy', () => {
	...
	const NOISE_STRONG = [
		0.457076, -1.559976, 1.125677, 1.410847, -2.926553, -1.953269, 0.191761, -0.474364, -0.025202,
		-1.279566, 1.319097, 1.166688, 0.099046, 1.690862, 0.701264, -1.288939, 0.553126, -1.438324,
		1.317675, -0.074889, -0.277294, -1.021394, 1.833812, -0.231794, -0.642492, -0.5282, 0.798464,
		0.548166, 0.619099, 0.646232, 3.212471, -0.609623, -0.768364, -1.220659, 0.923969, 1.693458,
		-0.170921, -1.260235, -1.236722, 0.975889, 1.114881, 0.814731, -0.998265, 0.348242, 0.175029,
		0.328033, 1.307143, 0.335393
	];
	const NOISE_WEAK = [
		2.036741, 0.202737, 0.867358, 1.893865, -4.371467, -0.959014, -1.411118, -1.916634, -0.825427,
		4.484824, -2.597493, 2.904835, -5.048609, -1.004655, 0.488259, 1.758667, 2.13368, 2.380042,
		-1.046175, -1.387055, 2.573928, -0.573913, -3.827059, -3.399862, -2.758357, 1.491482, 0.427277,
		2.071456, -1.281758, 0.475619, 1.876771, -0.92804, 1.370326, -1.985778, -1.089162, -1.145214,
		-3.587519, 1.460917, -1.408207, 0.037482, 1.44224, 1.339594, 1.996155, -0.295456, -1.269895,
		-0.239155, -5.062003, -4.341337
	];
	const mk = (amp, noise) =>
