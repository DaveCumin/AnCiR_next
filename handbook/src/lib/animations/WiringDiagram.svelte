...
<figure class="wire-fig" style="--h:{height}">
	<svg
		viewBox="0 0 520 200"
		role="img"
		aria-label="Two nodes on the canvas: an Import file source node whose output port is wired to the input port of an Actogram plot node."
	>
		<!-- connecting wire -->
	...
	<figcaption>
		...
		<strong>input port</strong> (left) to connect them. Data flows left to right; change a setting upstream
