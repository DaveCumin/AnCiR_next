<script>
	...
	import { C, setupCanvas, drawAxes, seededRNG, initPalette } from '$lib/animUtils.js';
	...
	function drawActogram(f) {
		...
		ctx.textAlign = 'center';
		hrs.forEach((h, i) => ctx.fillText(lbls[i], padL + (h / 48) * pW, padT + pH + 14));
...
<div class="anim-embed" style={height ? `height: ${height}` : undefined}>
	...
	<div class="controls">
		<button class="btn" bind:this={btnPlay} onclick={actoToggle}>&#9654; Play</button>
