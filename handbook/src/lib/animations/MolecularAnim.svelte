<script>
	...
	const STEPS = [
		...
		{
			active: ['mol-cb', 'mol-ebox', 'mol-percry', 'mol-tim', 'mol-complex', 'mol-inhibit'],
...
<div class="anim-embed">
	<div id="mol-wrap">
		<svg id="mol-svg" viewBox="0 0 720 460" xmlns="http://www.w3.org/2000/svg">
			<defs>
				<marker id="ar-green" markerWidth="7" markerHeight="7" refX="6" refY="3" orient="auto"
					><path d="M0,0 L7,3 L0,6 Z" fill="#137333" /></marker
				>
				<marker id="ar-gold" markerWidth="7" markerHeight="7" refX="6" refY="3" orient="auto"
					><path d="M0,0 L7,3 L0,6 Z" fill="#e6a817" /></marker
				>
				<marker id="ar-navy" markerWidth="7" markerHeight="7" refX="6" refY="3" orient="auto"
					><path d="M0,0 L7,3 L0,6 Z" fill="#003b71" /></marker
				>
				<marker id="ar-blue" markerWidth="7" markerHeight="7" refX="6" refY="3" orient="auto"
					><path d="M0,0 L7,3 L0,6 Z" fill="#4a90d9" /></marker
				>
				<marker id="ar-red" markerWidth="7" markerHeight="7" refX="6" refY="3" orient="auto"
					><path d="M0,0 L7,3 L0,6 Z" fill="#c5221f" /></marker
				>
				<marker id="ar-purple" markerWidth="7" markerHeight="7" refX="6" refY="3" orient="auto"
					><path d="M0,0 L7,3 L0,6 Z" fill="#7c3aed" /></marker
				>
				<marker id="ar-gray" markerWidth="7" markerHeight="7" refX="6" refY="3" orient="auto"
					><path d="M0,0 L7,3 L0,6 Z" fill="#6b7280" /></marker
				>
				<marker id="ar-inhibit" markerWidth="6" markerHeight="8" refX="4" refY="4" orient="auto"
					><rect x="3" y="0" width="2" height="8" fill="#c5221f" /></marker
				>
			</defs>

			<!-- compartment backgrounds -->
			<rect x="0" y="280" width="720" height="180" rx="0" fill="#eaf2fb" opacity="0.7" />
			<ellipse
				cx="360"
				cy="370"
				rx="200"
			...
			<g id="mol-cb" class="mol-group" opacity="0.1">
				...
				>
				<line x1="295" y1="316" x2="375" y2="316" stroke="#c8962e" stroke-width="2" />
				<text
					x="335"
					y="311"
					text-anchor="middle"
			...
			<g id="mol-tim" class="mol-group" opacity="0.1">
				...
				>
				<circle cx="536" cy="80" r="12" fill="#fef3c7" stroke="#c8962e" stroke-width="1.5" />
				<text x="536" y="85" text-anchor="middle" font-size="13" font-family="sans-serif"
					>&#9728;</text
				>
				<line
					x1="536"
				...
				/>
				<text x="552" y="102" font-size="9" font-family="Inter,sans-serif" fill="#dc2626"
					>light &#8594;</text
				>
				<text x="552" y="114" font-size="9" font-family="Inter,sans-serif" fill="#dc2626"
					>degrades</text
				>
			</g>
			...
			<g id="mol-complex" class="mol-group" opacity="0.1">
				...
				<line
					...
					marker-end="url(#ar-navy)"
				/>
				<text x="348" y="248" font-size="11" font-family="Inter,sans-serif" fill="#1a202c"
					>translocate</text
				>
			</g>
	...
	<div class="controls" style="justify-content: center; gap: 0.75rem; margin-top: 0.5rem">
