<script>
	...
	// Chapter cross-links are raw HTML, so they carry double quotes. Held as
	// constants rather than inline attributes: an inline single-quoted attribute
	// containing double quotes is rewritten by Prettier into a broken one.
	const CH_11_13 = 'Chapters <a href="#ch11">11</a> and <a href="#ch13">13</a>';
	const CH_5 = 'Chapter <a href="#ch5">5</a>';
	const CH_5_6 = 'Chapters <a href="#ch5">5</a> and <a href="#ch6">6</a>';
	const CH_6_13 = 'Chapters <a href="#ch6">6</a> and <a href="#ch13">13</a>';
	const CH_7 = 'Chapter <a href="#ch7">7</a>';
	const CH_7_12 = 'Chapters <a href="#ch7">7</a> and <a href="#ch12">12</a>';
	const CH_9 = 'Chapter <a href="#ch9">9</a>';
</script>

<ChapterSection id="recipes" num="Recipes" title="Recipes: Common Tasks, Start to Finish">
	<p class="chapter-intro">
		The method chapters explain <em>how</em> each analysis works. This section is the other way
		round: it starts from a <strong>goal</strong> and walks you through the exact node chain that gets
		you there, using a ready-made example session you can open in AnCiR and take apart. Each recipe links
		back to the chapter that explains the reasoning.
	</p>

	<NoteBox title="How to use a recipe">
		<p>
			Click <strong>Open this example in AnCiR</strong> to load the finished workflow on the canvas,
			then follow the steps below against it — double-click any node to see its settings, and change
			a value to watch every downstream plot update. The numbers quoted under
			<em>What to read off</em> are the values baked into that example session.
		</p>
	</NoteBox>
